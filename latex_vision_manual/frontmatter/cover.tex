...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=center] at ($(current page.center) + (0, -1.8cm)$) {
        \begin{tikzpicture}
            ...
            \begin{scope}
                \clip (0, 0.0) circle (1.65cm);
                \node[inner sep=0pt] at (0, 0.0) {
                    \includegraphics[width=3.5cm, height=3.5cm, keepaspectratio]{figures/logo.jpg}
                };
            \end{scope}

            % วงแหวนเรขาคณิตช่องมองภาพและเรดาร์วิเคราะห์ (Circular Reticle & Crosshairs)
            \draw[color=cyan!75, line width=1.3pt, opacity=0.85] (0, 0.0) circle (1.75cm);
            \draw[color=rbruGold!80, line width=0.8pt, dashed, opacity=0.7] (0, 0.0) circle (1.95cm);
            \draw[color=cyan!50, line width=0.8pt] (-2.6, 0.0) -- (-2.05, 0.0);
            \draw[color=cyan!50, line width=0.8pt] (2.05, 0.0) -- (2.6, 0.0);
            \draw[color=cyan!50, line width=0.8pt] (0, 2.15) -- (0, 1.85);
            \draw[color=cyan!50, line width=0.8pt] (0, -1.85) -- (0, -2.15);
            ...
            \draw[color=green!90!white, line width=1.6pt, opacity=0.95] 
                (-1.5, 0.9) -- (1.1, 1.2) -- (1.6, -0.4) -- (0.5, -1.3) -- (-1.3, -0.8) -- cycle;
            \fill[green!80!cyan, opacity=0.15]
                (-1.5, 0.9) -- (1.1, 1.2) -- (1.6, -0.4) -- (0.5, -1.3) -- (-1.3, -0.8) -- cycle;

            % จุดยอดพิกัดสัมผัส (Touch ROI Vertices)
            \fill[white] (-1.5, 0.9) circle (2.2pt);
            \fill[white] (1.1, 1.2) circle (2.2pt);
            \fill[white] (1.6, -0.4) circle (2.2pt);
            \fill[white] (0.5, -1.3) circle (2.2pt);
            \fill[white] (-1.3, -0.8) circle (2.2pt);
