/// Agricultural GPS Geotagging Data Model for SoilpH-HT
class GeoLocationData {
  ...
  /// Complete summary string: e.g. "12.60830° N, 102.11540° E | Alt: 42.5m"
  ...
  factory GeoLocationData.fromJson(Map<String, dynamic> json) {
    return GeoLocationData(
      latitude: (json['latitude'] as num?)?.toDouble() ?? 12.6083,
      longitude: (json['longitude'] as num?)?.toDouble() ?? 102.1154,
      altitude: (json['altitude'] as num?)?.toDouble() ?? 42.5,
