...
class GeoLocationService {
  ...
  Future<void> initLocationTracking() async {
    try {
      ...
      if (permission == LocationPermission.denied ||
        ...
        debugPrint('[GeoLocationService] Location permission denied. Using fallback plot coordinates.');
  ...
  void _emitLocation(GeoLocationData data) {
  ...
  /// Force manual GPS re-check
  Future<GeoLocationData> refreshLocation() async {
    try {
      ...
      debugPrint('[GeoLocationService] Manual refresh error: $e');
    }
