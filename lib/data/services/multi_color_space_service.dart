...
/// ข้อมูลปริภูมิสีหลากมิติสำหรับงานวิจัยภาพถ่ายดิน (Soil Multi-Color Space Metric)
class MultiColorMetric {
  ...
  final double labL;        // 0.0 - 100.0 (ความสว่าง ความมืดสัมพันธ์กับอินทรียวัตถุ SOM)
  final double labA;        // -128.0 - +127.0 (สีเขียวถึงสีแดง สัมพันธ์กับสารประกอบเหล็ก)
  final double labB;        // -128.0 - +127.0 (สีน้ำเงินถึงสีเหลือง)
  final double yCbCrY;      // 0.0 - 255.0 (ความสว่าง Luma)
  final double yCbCrCb;     // 0.0 - 255.0 (Chroma Blue)
  final double yCbCrCr;     // 0.0 - 255.0 (Chroma Red)
...
class MultiColorSpaceService {
  ...
  /// แปลงค่าพิกเซลดิบ (R, G, B) เป็น MultiColorMetric ครบ 4 ปริภูมิสี
  static MultiColorMetric fromRgb(int r, int g, int b) {
    ...
    // จุดขาวอ้างอิง D65 Reference White Point
